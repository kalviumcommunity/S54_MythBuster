...
const PostComponent = () => {
    ...
    const fetchData = async () => {
        const res = await fetch('https://mythbuster.onrender.com/myths')
...
//               src={myth.Image}
//               alt=""
//               className="object-cover w-14 md:w-40 h-40 md:h-auto rounded-md"
//             />
//             <div className="flex-1">
//               <h1 className="text-2xl md:text-3xl font-bold">{myth.Title}</h1>
